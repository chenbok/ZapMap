...
public class SearchRecyclerAdapter extends RecyclerView
    ...
    public SearchRecyclerAdapter(ArrayList<PlaceObj> myDataset) {
        mDataset = myDataset;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.serach_recycler_item, parent, false);
    ...
    public void addItem(PlaceObj placeObj, int index) {
        mDataset.add(placeObj);
